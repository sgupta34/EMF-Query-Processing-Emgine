	...
	public static void main(String[] args) 
	{
		...
		try 
		{
			...
			while (rs.next()) 
			{
				...
				{
					// Sigma(1)
					if((!(mfStruct.get("prod").get(i)+"").equals("null"))&&(!(mfStruct.get("month").get(i)+"").equals("null"))&&(prod.equals((String)mfStruct.get("prod").get(i)+""))&&(month.equals((int)mfStruct.get("month").get(i)+""))) 
					{
						// sum_1_quant
			...
			for(int i = 0; i < mfStruct.get("prod").size(); i++) 
			{
				...
				if(true) 
				{
					...
					// sum_1_quant
					if((mfStruct.get("sum_1_quant").get(i)+"").equals("null")) 
					{
						System.out.print(String.format("%16s", "null"));
					}
					else 
					{
						System.out.print(String.format("%16d", (int)mfStruct.get("sum_1_quant").get(i)));
					}
					// sum_2_quant
					...
					{
						System.out.print(String.format("%16d", (int)mfStruct.get("sum_2_quant").get(i)));
					}
					System.out.println();
				}
			}
