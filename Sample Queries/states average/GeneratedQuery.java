...
public class GeneratedQuery 
{
	...
	public static void main(String[] args) 
	{
		...
		mfStruct.put("sum_3_quant", new ArrayList<Integer>());
		...
		try 
		{
			...
			while (rs.next()) 
			{
				...
				{
					if(cust.equals((String)mfStruct.get("cust").get(i)+"")) 
					{
						flag = false;
						break;
					}
				...
				if(flag) 
				{
					...
					mfStruct.get("sum_3_quant").add(null);
			...
			while (rs.next()) 
			{
				...
				{
					// Sigma(1)
					if((!(mfStruct.get("cust").get(i)+"").equals("null"))&&(cust.equals((String)mfStruct.get("cust").get(i)+""))&&(state.equals("NY"+""))) 
					{
						// sum_1_quant
			...
			while (rs.next()) 
			{
				...
				{
					// Sigma(2)
					if((!(mfStruct.get("cust").get(i)+"").equals("null"))&&(cust.equals((String)mfStruct.get("cust").get(i)+""))&&(state.equals("CT"+""))) 
					{
						// sum_2_quant
			...
			while (rs.next()) 
			{
				...
				{
					// Sigma(3)
					if((!(mfStruct.get("cust").get(i)+"").equals("null"))&&(cust.equals((String)mfStruct.get("cust").get(i)+""))&&(state.equals("NJ"+""))) 
					{
						// sum_3_quant
						String _sum_3_quant = mfStruct.get("sum_3_quant").get(i)+"";
						if(_sum_3_quant.equals("null")) 
						{
							_sum_3_quant = "0";
						}
						mfStruct.get("sum_3_quant").set(i, (int)(Double.parseDouble(_sum_3_quant)+Double.parseDouble(quant)));
						// count_3_quant
			...
			{
				// having clause
				if((!(mfStruct.get("sum_2_quant").get(i)+"").equals("null"))&&(!(mfStruct.get("count_2_quant").get(i)+"").equals("null"))&&(!(mfStruct.get("sum_1_quant").get(i)+"").equals("null"))&&(!(mfStruct.get("count_1_quant").get(i)+"").equals("null"))&&(!(mfStruct.get("sum_3_quant").get(i)+"").equals("null"))&&(!(mfStruct.get("count_3_quant").get(i)+"").equals("null"))&&(Double.parseDouble((Double.parseDouble((int)mfStruct.get("sum_1_quant").get(i)+"")/Double.parseDouble((int)mfStruct.get("count_1_quant").get(i)+""))+"")>Double.parseDouble((Double.parseDouble((int)mfStruct.get("sum_2_quant").get(i)+"")/Double.parseDouble((int)mfStruct.get("count_2_quant").get(i)+""))+""))&&(Double.parseDouble((Double.parseDouble((int)mfStruct.get("sum_1_quant").get(i)+"")/Double.parseDouble((int)mfStruct.get("count_1_quant").get(i)+""))+"")>Double.parseDouble((Double.parseDouble((int)mfStruct.get("sum_3_quant").get(i)+"")/Double.parseDouble((int)mfStruct.get("count_3_quant").get(i)+""))+""))) 
				{
					rowNum++;
					// cust
					...
					// avg_3_quant
					if(((mfStruct.get("sum_3_quant").get(i)+"").equals("null"))||((mfStruct.get("count_3_quant").get(i)+"").equals("null"))) 
					{
						System.out.print(String.format("%16s", "null"));
					}
					else 
					{
						System.out.print(String.format("%16.3f", Double.parseDouble((int)mfStruct.get("sum_3_quant").get(i)+"")/Double.parseDouble((int)mfStruct.get("count_3_quant").get(i)+"")));
					}
					System.out.println();
				}
			}
