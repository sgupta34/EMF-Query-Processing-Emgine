...
public class GeneratedQuery 
{
	...
	public static void main(String[] args) 
	{
		...
		try 
		{
			...
			// print output
			int rowNum = 0;
			System.out.println("prod           monthcount_3_quantavg_2_quantsum_2_quantcount_2_quant");
			System.out.println("============================================================");
			for(int i = 0; i < mfStruct.get("prod").size(); i++) 
			{
				// having clause
				if(true) 
				{
					...
					{
						System.out.print(String.format("%-10s", (String)mfStruct.get("prod").get(i)));
					}
					// month
					...
					{
						System.out.print(String.format("%10d", (int)mfStruct.get("month").get(i)));
					}
					// count_3_quant
					...
					{
						System.out.print(String.format("%10d", (int)mfStruct.get("count_3_quant").get(i)));
					}
					// avg_2_quant
					...
					{
						System.out.print(String.format("%10.3f", Double.parseDouble((int)mfStruct.get("sum_2_quant").get(i)+"")/Double.parseDouble((int)mfStruct.get("count_2_quant").get(i)+"")));
					}
					// sum_2_quant
					if((mfStruct.get("sum_2_quant").get(i)+"").equals("null")) 
					{
						System.out.print(String.format("%10s", "null"));
					}
					else 
					{
						System.out.print(String.format("%10d", (int)mfStruct.get("sum_2_quant").get(i)));
					}
					// count_2_quant
					if((mfStruct.get("count_2_quant").get(i)+"").equals("null")) 
					{
						System.out.print(String.format("%10s", "null"));
					}
					else 
					{
						System.out.print(String.format("%10d", (int)mfStruct.get("count_2_quant").get(i)));
					}
					System.out.println();
				}
			}
